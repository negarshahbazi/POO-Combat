...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['name']) && !empty($_POST['name']) && isset($_POST['submit']) && isset($_POST['type'])) {
...
<body class="bg-dark background">
  ...
  <?php foreach ($users as $user) { ?>
    <form action="./fight.php" method="post" >
      <div class="card  bg-warning-subtle" style="width: 400px;">
        <div class="row ">
          <div class="col-md-6">
